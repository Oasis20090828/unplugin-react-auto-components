...
declare global {
  ...
  const AntBorderBeam: typeof import('antd')['BorderBeam']
  ...
  const AntMasonry: typeof import('antd')['Masonry']
  ...
  const App: typeof import('./components/App')['default']
  const ExtraHelloWorld: typeof import('./components/extra/Hello')['default']
  const HelloWorld: typeof import('./components/Hello')['default']
  const Home: typeof import('./pages/index')['default']
